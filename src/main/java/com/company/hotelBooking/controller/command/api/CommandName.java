...
public enum CommandName {
    ...
    UPDATE_USER_FORM, UPDATE_USER, UPDATE_ROOM_FORM, UPDATE_ROOM, LOGIN, LOGIN_FORM, LOGOUT, BOOKING,
    SEARCH_AVAILABLE_ROOMS, SEARCH_AVAILABLE_ROOMS_FORM, ROOMS_AVAILABLE, ERROR;
