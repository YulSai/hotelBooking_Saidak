...
public class RoomServiceImpl implements IRoomService {
	...
	public int countAllRooms() throws SQLException {
		log.debug("Calling a service method \"countAllRooms\". Time = {}", new Date());
		return roomDao.countAllRooms();
	}

	/**
	 * Method transform object Room into object RoomDto
	 *
	...
	/**
	 * Method transform object RoomDto into object Room
	 *
	 * @param dto RoomDto
	 * @return object Room
	 */
